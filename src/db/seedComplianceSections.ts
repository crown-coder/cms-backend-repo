...
import { complianceSections } from "./schema";

export const seedComplianceSections = async () => {
  await db.insert(complianceSections).values([
    {
    ...
    },
    {
      ...
      title:
        "Particulars of Directors on Business Letters, Show Cards, Trade Circulars",
    },
    {
    ...
    },
    {
      ...
      title:
        "Conspicuous Display of Statement of Affairs by Banks, Insurances Houses, PMIs, etc.",
    },
  ]);
